...
COMMON(int)		ar_add_ui(Number n, long add);
...
COMMON(Definition) 	trapUndefined(LocalFrame fr, Code PC,
				      Definition undef ARG_LD);
...
COMMON(void) 		ensure_room_stack(Stack s, int n);
